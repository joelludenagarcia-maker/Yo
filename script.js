/* =========================================================
   Joel Ludeña García — Landing (JS único)
   Parte 1: i18n (traducciones es/ca/en/de/it/fr/ar + RTL)
   Parte 2: interacciones (menú, scroll, reveal, formulario)
   Vanilla JS, sin dependencias.
   ========================================================= */

/* =========================================================
   Parte 1 — Internacionalización (i18n)
...
(function () {
  ...
  var DICT = {
    ...
    es: {
      ...
      "hero.title": "Llevo tu negocio a internet<br>sin complicaciones ni tecnicismos.",
      ...
      "about.p2": "No soy una gran agencia, y precisamente esa es la ventaja: hablas siempre conmigo, entiendo tu negocio de cerca y te lo explico todo con claridad, sin jerga técnica.",
      "about.photoAlt": "Retrato de Joel Ludeña García",
      "services.eyebrow": "Servicios", "services.title": "Lo que puedo hacer por tu negocio",
      "services.lead": "Soluciones concretas, sin extras innecesarios. Pagas solo por lo que de verdad necesitas.",
      ...
      "process.eyebrow": "Cómo trabajo", "process.title": "Cuatro pasos sencillos",
      "process.s1.title": "Contacto", "process.s1.text": "Me escribes por WhatsApp o llamas. Sin formularios interminables: empezamos con una conversación cercana.",
    ...
    ca: {
      ...
      "process.eyebrow": "Com treballo", "process.title": "Quatre passos senzills",
...
/* =========================================================
   Parte 2 — Interacciones de la interfaz
   ========================================================= */
(function () {
  "use strict";
  ...
  /* ---------- Selector de vista: ordenador / móvil ----------
     Cambia el ancho del contenedor .app (via clases) y, en móviles, el viewport,
     para poder forzar la disposición de ordenador o de móvil en cualquier equipo.
  ...
  (function () {
    ...
    var VP = {
      ...
      desktop: "width=1180",
      auto:    "width=device-width, initial-scale=1.0"
    };
    function getView() {
  ...
  function closeMenu() {
    ...
    toggle.setAttribute("aria-label", t("aria.menu", "Abrir menú"));
  }
  ...
  if (toggle && menu) {
    toggle.addEventListener("click", function () {
      ...
      toggle.setAttribute("aria-label", open ? t("aria.menuClose", "Cerrar menú") : t("aria.menu", "Abrir menú"));
    });
  ...
  // Acceso a las traducciones (Parte 1, arriba); con respaldo por si fallara.
